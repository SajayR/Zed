...
def process_scenes(screenplay_file: str, db, novel_text: str):
    ...
    for scene in root.findall('scene'):
        ...
        if dialogues is not None:
            for dialogue in dialogues.findall('dialogue'):
                ...
                character_info = get_or_create_character(db, character_name, novel_text)  # Pass an empty string for novel_text
...
if __name__ == "__main__":
    test_pdf_path = "/Users/cisco/Documents/CisStuff/ZedDark /Harry Potter Sorcerers Stone.pdf"
    main(test_pdf_path)